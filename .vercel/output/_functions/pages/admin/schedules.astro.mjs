  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onDismiss, className: "opacity-40 hover:opacity-70 ml-1 text-xs", children: "✕" })
      ]
    }
  );
}
...
function Avatar({ name, size = "sm" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${sizeClass} rounded-full bg-purple-100 text-purple-700 flex items-center justify-center font-bold flex-shrink-0`, children: initials });
}
  ...
  async function fetchAll() {
    ...
    try {
      const [sr, tr] = await Promise.all([
        fetch("/api/schedules").then((r2) => r2.json()),
        fetch("/api/students").then((r2) => r2.json())
      ]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-gray-800 bg-gray-50 min-h-screen p-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Class Schedules" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mt-1", children: "Manage classes and automated Telegram reminders" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-4", children: ["all", ...DAYS.map((_, i) => i)].map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-2 border-purple-500 border-t-transparent rounded-full animate-spin" }) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-24 text-center px-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold text-gray-700", children: "No schedules found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-400 mt-1 mb-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: deletingId === sc._id ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 border border-red-400 border-t-transparent rounded-full animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" }) })
            }
          )
        ] }) })
      ] }, sc._id)) })
    ] }) }) }),
    modalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl w-full max-w-xl shadow-xl fade-up max-h-[90vh] overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-5 border-b border-gray-100 sticky top-0 bg-white z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "px-6 py-5 space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Field, { label: "Student", required: true, children: [
          ...
          selectedStudent && !selectedStudent.telegramChatId && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-amber-500 text-xs mt-1.5 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "⚠" }),
            " No Telegram ID — reminders won't be sent"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Class Name", required: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              required: true,
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Day", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              value: form.dayOfWeek,
              onChange: (e) => setForm({ ...form, dayOfWeek: +e.target.value }),
              className: inputCls,
              children: DAYS.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: i, children: d }, d))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Time", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "time",
              value: form.time,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Duration", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              value: form.duration,
              onChange: (e) => setForm({ ...form, duration: +e.target.value }),
              className: inputCls,
              children: [30, 45, 60, 90, 120].map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: d, children: [
                d,
                " min"
              ] }, d))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Remind Before", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              value: form.reminderMinutes,
              onChange: (e) => setForm({ ...form, reminderMinutes: +e.target.value }),
              className: inputCls,
              children: [5, 15, 30, 60, 120, 1440].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: m, children: [
                m >= 60 ? `${m / 60}h` : `${m}min`,
                " before"
              ] }, m))
            }
        ...
        form.studentId && form.className && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-50 border border-purple-100 rounded-xl p-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-purple-100 rounded-lg p-3 text-sm text-gray-700 space-y-0.5 font-mono shadow-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("b", { className: "text-gray-900", children: "Class Reminder" })
            ] }),
    ...
    deleteTarget && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl w-full max-w-sm shadow-xl fade-up p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-sm mb-6", children: [
        ...
        " for",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-gray-900", children: deleteTarget.studentId.name }),
