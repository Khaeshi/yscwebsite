...
function Toast({ toast, onDismiss }) {
  return /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-3 px-4 py-3 rounded-xl shadow-lg text-sm font-medium border bg-white ${toast.type === "success" ? "border-green-200 text-green-800" : "border-red-200 text-red-800"}`, children: [
...
function SettingsManager() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "text-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-sm mt-1", children: "Configure your school and system preferences" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx("div", { className: "w-48 flex-shrink-0", children: /* @__PURE__ */ jsx("nav", { className: "space-y-1", children: tabs.map((tab) => /* @__PURE__ */ jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
        activeTab === "general" && /* @__PURE__ */ jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl p-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-base font-bold text-gray-900 mb-5", children: "General Settings" }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 max-w-lg", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: labelCls, children: "School Name" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: labelCls, children: "Admin Email" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "email",
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: labelCls, children: "Timezone" }),
                /* @__PURE__ */ jsxs("select", { value: general.timezone, onChange: (e) => setGeneral({ ...general, timezone: e.target.value }), className: inputCls, children: [
                  /* @__PURE__ */ jsx("option", { value: "Asia/Manila", children: "Asia/Manila (PHT)" }),
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("select", { value: general.currency, onChange: (e) => setGeneral({ ...general, currency: e.target.value }), className: inputCls, children: [
                  /* @__PURE__ */ jsx("option", { value: "PHP", children: "PHP (₱)" }),
                  /* @__PURE__ */ jsx("option", { value: "USD", children: "USD ($)" }),
                  /* @__PURE__ */ jsx("option", { value: "SGD", children: "SGD (S$)" })
                ] })
              ] })
            ] }),
        ...
        activeTab === "telegram" && /* @__PURE__ */ jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl p-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-base font-bold text-gray-900 mb-1", children: "Telegram Bot Settings" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mb-5", children: "Configure your Telegram bot for automated class reminders." }),
          /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-xl p-4 mb-5 text-sm text-blue-700", children: [
            /* @__PURE__ */ jsx("strong", { children: "Setup:" }),
            " Create a bot via ",
            /* @__PURE__ */ jsx("code", { className: "bg-blue-100 px-1 rounded", children: "@BotFather" }),
            " on Telegram → get your token → paste below."
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 max-w-lg", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: labelCls, children: "Bot Token" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "password",
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-1", children: "Keep this secret. Never share it publicly." })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: labelCls, children: "Bot Username" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: labelCls, children: "Default Reminder (minutes before class)" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("option", { value: "1440", children: "1 day before" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: labelCls, children: "Reminder Message Template" }),
              /* @__PURE__ */ jsx(
                "textarea",
                {
                  rows: 3,
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-400 mt-1", children: [
                ...
                " ",
                /* @__PURE__ */ jsx("code", { className: "bg-gray-100 px-1 rounded", children: "{class}" }),
                " ",
                /* @__PURE__ */ jsx("code", { className: "bg-gray-100 px-1 rounded", children: "{minutes}" })
              ] })
            ] }),
        ...
        activeTab === "notifications" && /* @__PURE__ */ jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl p-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-base font-bold text-gray-900 mb-5", children: "Notification Preferences" }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 max-w-lg", children: [
            [
            ...
            ].map((item) => /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4 py-3 border-b border-gray-50 last:border-0", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-900", children: item.label }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: item.desc })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsx("span", { className: `inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform ${notifications[item.key] ? "translate-x-6" : "translate-x-1"}` })
                }
              )
            ] }, item.key)),
            /* @__PURE__ */ jsx("div", { className: "pt-2", children: /* @__PURE__ */ jsx(
        ...
        activeTab === "danger" && /* @__PURE__ */ jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white border border-red-200 rounded-2xl p-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-base font-bold text-red-600 mb-1", children: "Danger Zone" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mb-5", children: "These actions are irreversible. Please proceed with caution." }),
          ...
          ].map((item) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4 p-4 border border-red-100 rounded-xl bg-red-50/30", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-gray-900", children: item.label }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-0.5", children: item.desc })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
