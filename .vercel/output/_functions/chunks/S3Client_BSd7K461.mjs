...
import { Writable, Readable as Readable$1, PassThrough } from "stream";
import crypto$1, { createHmac, createHash } from "crypto";
import { Readable, Writable as Writable$1 } from "node:stream";
import { _ as __awaiter, a as __generator, b as __values } from "./tslib.es6_BvpYHRB1.mjs";
...
class HttpProtocol extends SerdeContext {
  ...
  async loadEventStreamCapability() {
    const { EventStreamSerde } = await import("./index_BZbMXh6G.mjs");
...
class Matcher {
  ...
  toString(separator, includeNamespace = true) {
    ...
    return this.path.map((n2) => {
      if (includeNamespace && n2.namespace) {
        return `${n2.namespace}:${n2.tag}`;
      }
      return n2.tag;
    }).join(sep2);
  }
...
const remoteProvider = async (init) => {
  const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await import("./index_Yofz20E_.mjs");
  if (process.env[ENV_CMDS_RELATIVE_URI] || process.env[ENV_CMDS_FULL_URI]) {
    init.logger?.debug("@aws-sdk/credential-provider-node - remoteProvider::fromHttp/fromContainerMetadata");
    const { fromHttp } = await import("./index__Y9HRHYj.mjs");
...
`);
  ...
  async (awsIdentityProperties) => {
    ...
    const { fromSSO } = await import("./index_lirXJDNM.mjs");
    return fromSSO(init)(awsIdentityProperties);
  },
  async (awsIdentityProperties) => {
    init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromIni");
    const { fromIni } = await import("./index_Cd6hznXg.mjs");
    return fromIni(init)(awsIdentityProperties);
  },
  async (awsIdentityProperties) => {
    init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
    const { fromProcess } = await import("./index_B6cuPliK.mjs");
    return fromProcess(init)(awsIdentityProperties);
  },
  async (awsIdentityProperties) => {
    init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
    const { fromTokenFile } = await import("./index_b7YA2NIy.mjs");
...
const inferPhysicalRegion = async () => {
  ...
  if (!process.env[ENV_IMDS_DISABLED]) {
    try {
      const { getInstanceMetadataEndpoint, httpRequest } = await import("./index_Yofz20E_.mjs");
...
export {
  ServiceException as $,
  parseRfc7231DateTime as A,
  parseRfc3339DateTimeWithOffset as B,
  ...
  HttpRequest as H,
  v4 as I,
  HttpBindingProtocol as J,
  HttpInterceptingShapeSerializer as K,
  LazyJsonString as L,
  ...
  TypeRegistry as T,
  UnionSerde as U,
  normalizeProvider$1 as V,
  getSmithyContext as W,
  EndpointCache as X,
  resolveEndpoint as Y,
  awsEndpointFunctions as Z,
  customEndpointFunctions as _,
  ENV_CREDENTIAL_SCOPE as a,
  setFeature$1 as a$,
  parseUrl as a0,
  NoOpLogger as a1,
  AwsSdkSigV4Signer as a2,
  emitWarningIfUnsupportedVersion as a3,
  resolveDefaultsModeConfig as a4,
  emitWarningIfUnsupportedVersion$1 as a5,
  streamCollector$1 as a6,
  calculateBodyLength as a7,
  loadConfig as a8,
  NODE_APP_ID_CONFIG_OPTIONS as a9,
  getHostHeaderPlugin as aA,
  getLoggerPlugin as aB,
  getRecursionDetectionPlugin as aC,
  getHttpAuthSchemeEndpointRuleSetPlugin as aD,
  DefaultIdentityProviderConfig as aE,
  getHttpSigningPlugin as aF,
  resolveHostHeaderConfig as aG,
  ProviderError as aH,
  IniSectionType as aI,
  CONFIG_PREFIX_SEPARATOR as aJ,
  getConfigFilepath as aK,
  parseIni as aL,
  HttpProtocol as aM,
  extendedEncodeURIComponent as aN,
  XmlShapeDeserializer as aO,
  deref as aP,
  isReadableStream as aQ,
  DEFAULT_CHECKSUM_ALGORITHM as aR,
  RequestChecksumCalculation as aS,
  ChecksumAlgorithm as aT,
  isArrayBuffer as aU,
  isEmptyData as aV,
  convertToBuffer as aW,
  numToUint8 as aX,
  uint32ArrayFrom as aY,
  AwsCrc32 as aZ,
  toUint8Array as a_,
  NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS as aa,
  NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS as ab,
  Hash as ac,
  NODE_RETRY_MODE_CONFIG_OPTIONS as ad,
  DEFAULT_RETRY_MODE as ae,
  NODE_REGION_CONFIG_FILE_OPTIONS as af,
  NODE_REGION_CONFIG_OPTIONS as ag,
  NODE_MAX_ATTEMPT_CONFIG_OPTIONS as ah,
  createDefaultUserAgentProvider as ai,
  NODE_AUTH_SCHEME_PREFERENCE_OPTIONS as aj,
  loadConfigsForDefaultMode as ak,
  getAwsRegionExtensionConfiguration as al,
  getDefaultExtensionConfiguration as am,
  getHttpHandlerExtensionConfiguration as an,
  resolveAwsRegionExtensionConfiguration as ao,
  resolveDefaultRuntimeConfig as ap,
  resolveHttpHandlerRuntimeConfig as aq,
  Client as ar,
  resolveUserAgentConfig as as,
  resolveRetryConfig as at,
  resolveRegionConfig as au,
  resolveEndpointConfig as av,
  getSchemaSerdePlugin as aw,
  getUserAgentPlugin as ax,
  getRetryPlugin as ay,
  getContentLengthPlugin as az,
  ENV_EXPIRATION as b,
  ResponseChecksumValidation as b0,
  PutObject$ as b1,
  ENV_KEY as c,
  ENV_SECRET as d,
  ENV_SESSION as e,
  ...
  getEndpointPlugin as m,
  getThrow200ExceptionsPlugin as n,
  getProfileName as o,
  sdkStreamMixin as p,
  parseRfc3339DateTime as q,
  NumericValue as r,
  setCredentialFeature as s,
  toUtf8 as t,
  collectBody$1 as u,
  SerdeContextConfig as v,
  NormalizedSchema as w,
  fromBase64 as x,
  determineTimestampFormat as y,
  parseEpochTimestamp as z
};
