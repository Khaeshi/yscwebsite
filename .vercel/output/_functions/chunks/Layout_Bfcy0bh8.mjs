  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between h-14 sm:h-16 lg:h-20", children: [
          /* @__PURE__ */ jsx("a", { href: "/", className: "flex items-center group", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: logoImg.src,
          ...
          /* @__PURE__ */ jsxs("nav", { className: "hidden lg:flex items-center gap-1", children: [
            isHomePage ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(
                "button",
                {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-2xl border border-gray-100 p-6 w-[600px]", children: [
                        /* @__PURE__ */ jsx("div", { className: "text-xs uppercase tracking-wider text-gray-500 mb-4 px-2", children: "Explore Our Programs" }),
                        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: programs.map((program) => /* @__PURE__ */ jsx(
                          "a",
                          {
                            href: program.path,
                            ...
                            children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                              /* @__PURE__ */ jsx("div", { className: `w-10 h-10 rounded-lg bg-gradient-to-br ${program.gradient} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-200`, children: /* @__PURE__ */ jsx(program.icon, { className: "w-5 h-5 text-white" }) }),
                              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                                /* @__PURE__ */ jsx("h4", { className: "font-semibold text-gray-900 group-hover:text-purple-700 transition-colors mb-0.5", children: program.name }),
                                /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 leading-tight", children: program.description })
                              ] })
                            ] })
                          },
                          program.id
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: mobileMenuOpen ? /* @__PURE__ */ jsx(X, { className: `w-6 h-6 ${scrolled ? "text-gray-900" : "text-white"}` }) : /* @__PURE__ */ jsx(Menu, { className: `w-6 h-6 ${scrolled ? "text-gray-900" : "text-white"}` })
            }
          )
        ] }) })
      }
    ...
    mobileMenuOpen && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "fixed left-0 right-0 top-20 sm:top-24 bottom-auto max-h-[calc(100vh-6rem)] z-[56] lg:hidden animate-in fade-in slide-in-from-top-4 duration-300 px-4", children: /* @__PURE__ */ jsx("div", { className: "bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden max-w-lg mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "overflow-y-auto max-h-[calc(100vh-8rem)] p-6", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            onClick: () => setMobileMenuOpen(false),
            children: [
              /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-purple-500" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              ...
              " ",
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: "About" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Programs" }),
                /* @__PURE__ */ jsx(
                  "svg",
                  {
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: programs.map((program) => /* @__PURE__ */ jsxs(
                "a",
                {
                  href: program.path,
                  ...
                  onClick: () => setMobileMenuOpen(false),
                  children: [
                    /* @__PURE__ */ jsx("div", { className: `w-12 h-12 rounded-xl bg-gradient-to-br ${program.gradient} flex items-center justify-center flex-shrink-0`, children: /* @__PURE__ */ jsx(program.icon, { className: "w-6 h-6 text-white" }) }),
                    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsx("div", { className: "font-semibold text-gray-900 mb-1", children: program.name }),
                      /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500", children: program.description })
                    ] })
                  ]
                },
                program.id
        ...
        /* @__PURE__ */ jsx("div", { className: "space-y-2 mb-6", children: isHomePage ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: () => {
              setMobileMenuOpen(false);
            ...
            className: "flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gray-50 transition-all duration-200",
            children: [
              /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-pink-500" }),
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Testimonials" })
            ]
          }
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              className: "flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gray-50 transition-all duration-200",
              children: [
                /* @__PURE__ */ jsx(MapPin, { className: "w-5 h-5 text-orange-500" }),
...
function Footer() {
  return /* @__PURE__ */ jsxs("footer", { className: "bg-gradient-to-br from-purple-900 via-pink-900 to-orange-900 text-white", children: [
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 sm:px-4 lg:px-6 py-12", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsx("a", { href: "/", children: /* @__PURE__ */ jsx(
          "img",
          {
            src: logoImg.src,
            alt: "Young Starter Club",
        ...
        /* @__PURE__ */ jsx("p", { className: "text-white/80", children: "Empowering children and adults to discover their creative talents through quality lessons in music, sports, arts, and more." })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "mb-4", children: "Quick Links" }),
        /* @__PURE__ */ jsxs("ul", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/#programs", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "Our Programs" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/#testimonials", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "Testimonials" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/#location", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "Location" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/aboutpage", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "About Us" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "mb-4", children: "Our Programs" }),
        /* @__PURE__ */ jsxs("ul", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/music-teaching", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "Music Teaching" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/badminton-coaching", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "Badminton Coaching" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/arts-lesson", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "Arts Lessons" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/cooking-session", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "Cooking Sessions" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/photography-classes", className: "text-white/80 hover:text-white transition-transform transition-colors inline-block duration-300 hover:translate-x-1", children: "Photography Classes" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "mb-4 font-medium", children: "Get in Touch" }),
        /* @__PURE__ */ jsxs("ul", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2 text-white/80", children: [
            /* @__PURE__ */ jsx(Phone, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsx("span", { children: "(+63) 949-077-5573" })
          ] }),
          /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2 text-white/80", children: [
            /* @__PURE__ */ jsx(Mail, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsx("span", { children: "youngstarterclub@gmail.com" })
          ] }),
          /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2 text-white/80", children: [
            /* @__PURE__ */ jsx(MapPin, { className: "w-4 h-4 mt-1 flex-shrink-0" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-6", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-white mb-4", children: "Follow Us" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "border-t border-white/20 p-6 text-center text-white/60", children: /* @__PURE__ */ jsx("p", { children: "© 2025 Young Starter Club. All rights reserved." }) })
  ] });
}
