import { au as getAugmentedNamespace } from "./astro/server_D7hC0Tqo.mjs";
...
async function render(node) {
  let render2;
  try {
    ({ render: render2 } = await import("./render_resend_19t8IPfy.mjs"));
  } catch {
  ...
  async performCreate(payload) {
    if (payload.react) {
      if (!this.renderAsync) try {
        const { renderAsync } = await import("./render_resend_19t8IPfy.mjs");
