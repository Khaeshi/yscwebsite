...
import { a as artsimageUrl } from "../chunks/config_Dwxu8MQG.mjs";
import { P as Palette } from "../chunks/index_os-mkKwH.mjs";
...
const $$ArtsLesson = createComponent(($$result, $$props, $$slots) => {
  const instructors = [
    {
      name: "",
      title: "Lead Art Instructor & Creative Director",
      image: "",
      specialization: ["Watercolor", "Acrylic Painting", "Mixed Media", "Art History"],
      experience: "14+ years teaching experience",
      description: "Isabella holds a BFA in Fine Arts from Rhode Island School of Design. Her artwork has been featured in numerous galleries and exhibitions across the region. As an educator, she's passionate about helping students discover their creative voice while building technical skills. Isabella believes that art education goes beyond technique – it's about fostering confidence, self-expression, and seeing the world from new perspectives.",
      achievements: [
        "Exhibited artwork in 20+ galleries and art shows",
        "Winner of Regional Art Educator of the Year award",
        "Published in Art Education Magazine",
        "Developed 'Art for Everyone' inclusive curriculum"
      ]
    }
  ];
  const historyMilestones = [
    {
      ...
      description: "Opened our first art studio with the mission to make quality art education accessible to all ages and backgrounds."
    },
    {
      year: "2014",
      title: "Program Expansion",
      description: "Added specialized classes in digital art, sculpture, and portfolio preparation for aspiring art students."
    },
    {
      year: "2018",
      title: "Community Impact",
      description: "Launched annual student art exhibition and community mural projects, showcasing over 200 student artworks."
    },
    {
      year: "2024",
      title: "Innovation & Growth",
      description: "Integrated modern digital art tools while maintaining focus on traditional techniques, serving 400+ students."
    }
  ];
  const pageTitle = "Arts | Young Starter Club";
  const description = "Learn to draw with confidence! Young Starter Club offers beginner-friendly drawing lessons for all ages. Master essential techniques and unleash your creativity.";
  const image = "/assets/YSC.png";
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": pageTitle, "description": description, "image": image }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="min-h-screen bg-white">  ${renderComponent($$result2, "ParallaxHero", ParallaxHero, { "imageUrl": artsimageUrl, "title": "Unleash Your Creativity", "subtitle": "Explore the wonderful world of visual arts through painting, drawing, sculpture, and mixed media. Our experienced instructors nurture creativity while teaching fundamental techniques in a supportive, inspiring environment.", "stats": [
...
</p> </div> <div class="space-y-8"> ${instructors.map((instructor, index) => renderTemplate`${renderComponent($$result2, "InstructorProfile", InstructorProfile, { "key": index, ...instructor })}`)} </div> </div> </section>  <section class="py-20 bg-white"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> ${renderComponent($$result2, "ProgramHistorySection", ProgramHistorySection, { "image": "https://images.unsplash.com/photo-1649479117144-49ae67b86632?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnQlMjBwYWludGluZyUyMHN0dWRpb3xlbnwxfHx8fDE3NjAyMzc4OTF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral", "foundedYear": "2011", "milestones": historyMilestones, "stats": [
    { icon: Users, value: "400+", label: "Students" },
    { icon: Award, value: "10+", label: "Exhibitions" },
    { icon: Palette, value: "1000+", label: "Artworks" }
  ] })} </div> </section>  ${renderComponent($$result2, "ParallaxSection", ParallaxSection, { "imageUrl": "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnQlMjBwYWludGluZyUyMGNvbG9yZnVsfGVufDF8fHx8MTc2NDU3Njk0N3ww&ixlib=rb-4.1.0&q=80&w=1080", "className": "py-20" }, { "default": ($$result3) => renderTemplate` <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center"> ${renderComponent($$result3, "Palette", Palette, { "className": "w-12 h-12 mx-auto mb-6 text-yellow-300" })} <h2 class="mb-6 text-white">Ready to Create Amazing Art?</h2> <p class="mb-8 max-w-2xl mx-auto text-white/90">
Join our vibrant community of young artists. Contact us on Facebook to schedule your first class!
