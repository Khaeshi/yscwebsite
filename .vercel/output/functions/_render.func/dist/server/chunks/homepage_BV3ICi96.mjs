import { w as getDefaultExportFromCjs, e as createAstro, f as createComponent, l as renderComponent, r as renderTemplate, h as addAttribute, m as maybeRenderHead } from "./astro/server_Cfl3Ur0m.mjs";
import { j as jsxRuntimeExports } from "./jsx-runtime_mS7YKmDK.mjs";
import { a as reactExports, R as React } from "./_@astro-renderers_B4KjVBz-.mjs";
import { S as Star, C as CircleCheck } from "./star_duA439qC.mjs";
import { c as createLucideIcon, B as Button, M as MapPin, r as requireReactDom, e as composeRefs, u as useComposedRefs, X, f as cn, T as Trophy, a as Music, P as Palette, C as ChefHat, b as Camera, d as MessageCircle } from "./index_tryOdpTZ.mjs";
import { B as Badge, C as Card, I as ImageWithFallback } from "./ImageWithFallback_DnT8B4a9.mjs";
import { P as ParallaxSection } from "./ParallaxSection_CxInqIK5.mjs";
import { p as photographyimageUrl, k as homeimageUrl } from "./config_DXHxkv4J.mjs";
import { S as Sparkles } from "./sparkles_CIAmSsCs.mjs";
import { C as Calendar } from "./calendar_CPFXlUdr.mjs";
import { A as ArrowRight } from "./arrow-right_D1WKcfHu.mjs";
import { U as Users } from "./users_CVZbG-IS.mjs";
import { H as Heart } from "./heart_D8Ni6TjC.mjs";
/**
...
const TestimonialCard = ({ testimonial }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow h-full flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg ${testimonial.color}`, children: testimonial.initials }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-4 flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-gray-900 truncate", children: testimonial.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: testimonial.role }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: testimonial.date })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex mb-4", children: Array.from({ length: 5 }, (_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Star,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-700 text-sm leading-relaxed flex-grow mb-4", children: [
      '"',
      testimonial.content,
      '"'
    ] }),
    testimonial.isRecommended && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-green-600 pt-2 border-t border-gray-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThumbsUp, { className: "w-4 h-4 mr-1 fill-current" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: "Recommends Young Starter Club" })
    ] })
  ] });
};
...
function EventModal({ disabled = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isOpen, onOpenChange: setIsOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-[600px] p-0 gap-0 overflow-hidden border-2 border-purple-200 bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "sr-only", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "I'm Dreaming of an Art Christmas" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: 'Join our exciting artwork competition with the theme "The True Meaning of Christmas" and win amazing prizes!' })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 p-8 pb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/20 backdrop-blur-sm rounded-full p-2 sm:p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-6 w-6 sm:h-8 sm:w-8 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-white/90 text-purple-700 hover:bg-white px-2 sm:px-3 py-1 text-xs sm:text-sm", children: "Special Event" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white text-xl sm:text-2xl md:text-3xl mb-2 leading-tight", children: "🎨 I'm Dreaming of an Art Christmas" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 text-sm sm:text-base md:text-lg", children: 'Artwork Competition - "The True Meaning of Christmas"' })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 sm:p-6 md:p-8 -mt-4 sm:-mt-6 bg-white rounded-t-2xl sm:rounded-t-3xl relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 sm:space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg p-1.5 sm:p-2 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-4 w-4 sm:h-5 sm:w-5 text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-1 text-sm sm:text-base", children: "Amazing Prizes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-muted-foreground", children: "Win up to ₱1,000 cash prize plus consolation prizes for all participants!" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg p-1.5 sm:p-2 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4 sm:h-5 sm:w-5 text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-1 text-sm sm:text-base", children: "Important Dates" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-muted-foreground", children: "Submission Deadline: December 18, 2025 | Awards: December 20, 2025" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t pt-4 sm:pt-6 mt-4 sm:mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-muted-foreground mb-4 sm:mb-6 text-xs sm:text-sm md:text-base px-2", children: "Ready to showcase your artistic talents? Check out the complete competition rules, judging criteria, and submission guidelines!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              size: "lg",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/Events/event-guidelines", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center justify-center gap-2", children: [
                "View Competition Guidelines",
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4 sm:h-5 sm:w-5" })
              ] }) })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const $$Homepage = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const features = [
    ...
    { icon: CircleCheck, title: "Flexible Scheduling", description: "Choose times that work best for your lifestyle" }
  ];
  const stats = [
  ...
  return renderTemplate`${renderComponent($$result, "EventModal", EventModal, { "disabled": true, "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Escanorrrrr/OneDrive/Desktop/Khaesey Files/yscwebsite/src/components/EventModal.tsx", "client:component-export": "EventModal" })}${renderComponent($$result, "ParallaxSection", ParallaxSection, { "imageUrl": homeimageUrl, ";": true, "className": "pt-20 sm:pt-24 lg:pt-32 pb-20 sm:pb-24 lg:pb-32", "overlayOpacity": 0.7, "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Escanorrrrr/OneDrive/Desktop/Khaesey Files/yscwebsite/src/components/ParallaxSection.tsx", "client:component-export": "ParallaxSection" }, { "default": async ($$result2) => renderTemplate`${maybeRenderHead()}<div class="container mx-auto px-4 sm:px-6 lg:px-8"><div class="grid lg:grid-cols-2 gap-12 items-center"><!-- Left Content --><div class="text-white"><div class="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-white/30">${renderComponent($$result2, "Sparkles", Sparkles, { "className": "w-4 h-4" })}<span class="text-sm">Empowering Learners Since 2010</span></div><h1 class="text-4xl sm:text-5xl lg:text-6xl mb-6 text-white">
Discover Your
...
}, "C:/Users/Escanorrrrr/OneDrive/Desktop/Khaesey Files/yscwebsite/src/pages/homepage.astro", void 0);
const $$file = "C:/Users/Escanorrrrr/OneDrive/Desktop/Khaesey Files/yscwebsite/src/pages/homepage.astro";
const $$url = "/homepage";
