import { f as createComponent, l as renderComponent, n as renderSlot, r as renderTemplate, e as createAstro, o as defineScriptVars, p as renderScript, h as addAttribute, k as renderHead } from "./astro/server_CoVo9Zif.mjs";
/* empty css                         */
import { $ as $$InternalUIComponentRenderer } from "./InternalUIComponentRenderer_B2vWWpGe.mjs";
...
}, "C:/Users/user/Desktop/OngoingProjects/YSCMIGRATE/yscwebsite/node_modules/@clerk/astro/components/interactive/UserButton/UserButton.astro", void 0);
...
}, "C:/Users/user/Desktop/OngoingProjects/YSCMIGRATE/yscwebsite/node_modules/@clerk/astro/components/interactive/UserButton/MenuItemRenderer.astro", void 0);
...
}, "C:/Users/user/Desktop/OngoingProjects/YSCMIGRATE/yscwebsite/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonLink.astro", void 0);
...
}, "C:/Users/user/Desktop/OngoingProjects/YSCMIGRATE/yscwebsite/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonAction.astro", void 0);
const $$UserButtonMenuItems = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "clerk-user-button-menu-items", "clerk-user-button-menu-items", {}, { "default": () => renderTemplate` ${renderSlot($$result, $$slots["default"])} ` })} ${renderScript($$result, "C:/Users/user/Desktop/OngoingProjects/YSCMIGRATE/yscwebsite/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonMenuItems.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/user/Desktop/OngoingProjects/YSCMIGRATE/yscwebsite/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonMenuItems.astro", void 0);
...
}, "C:/Users/user/Desktop/OngoingProjects/YSCMIGRATE/yscwebsite/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonUserProfilePage.astro", void 0);
...
const $$AdminLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/x-icon" href="/YSC.ico"><title>${title}</title><meta name="description"${addAttribute(description, "content")}><meta property="og:image"${addAttribute(image, "content")}><meta name="robots" content="noindex, nofollow">${renderHead()}</head> <body class="min-h-screen bg-gray-50"> <!-- Sidebar --> <aside class="fixed top-0 left-0 z-50 h-screen w-64 bg-white border-r border-gray-200"> <div class="flex flex-col h-full"> <!-- Logo --> <div class="flex items-center h-16 px-6 border-b border-gray-200"> <a href="/admin" class="flex items-center gap-2"> <div class="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg"></div> <span class="font-bold text-lg">YSC Admin</span> </a> </div> <!-- Navigation --> <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto"> ${navItems.map((item) => renderTemplate`<a${addAttribute(item.href, "href")}${addAttribute(`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive(item.href) ? "bg-purple-50 text-purple-600 font-medium" : "text-gray-700 hover:bg-gray-100"}`, "class")}> <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"${addAttribute(item.icon, "d")}></path> </svg> <span>${item.label}</span> </a>`)} </nav> <!-- Logout with Clerk UserButton --> <div class="p-4 border-t border-gray-200"> <div class="flex items-center gap-3 px-4 py-3"> ${renderComponent($$result, "UserButton", UserButton, { "afterSignOutUrl": "/admin/login", "appearance": {
    elements: {
      avatarBox: "w-10 h-10",
      userButtonPopoverCard: "shadow-lg"
    }
  } })} <span class="text-sm font-medium text-gray-700">Admin</span> </div> </div> </div> </aside> <!-- Main content --> <div class="pl-64"> <!-- Top bar --> <header class="sticky top-0 z-30 h-16 bg-white border-b border-gray-200"> <div class="flex items-center justify-end h-full px-6"> ${renderComponent($$result, "UserButton", UserButton, { "afterSignOutUrl": "/admin/login" })} </div> </header> <!-- Page content --> <main class="p-6"> ${renderSlot($$result, $$slots["default"])} </main> </div> </body></html>`;
}, "C:/Users/user/Desktop/OngoingProjects/YSCMIGRATE/yscwebsite/src/layouts/AdminLayout.astro", void 0);
export {
  $$AdminLayout as $
};
