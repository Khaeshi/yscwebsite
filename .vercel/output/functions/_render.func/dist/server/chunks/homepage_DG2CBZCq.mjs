...
import { B as Badge, C as Card, I as ImageWithFallback } from "./ImageWithFallback_DmNFEcv8.mjs";
import { P as ParallaxSection } from "./ParallaxSection_Bo61cpqn.mjs";
import { format } from "date-fns";
import { B as Button, c as cn } from "./button_DVerbMlt.mjs";
...
function Dialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DialogPrimitive.Root, { "data-slot": "dialog", ...props });
}
function DialogPortal({
  ...props
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DialogPrimitive.Portal, { "data-slot": "dialog-portal", ...props });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogPortal, { "data-slot": "dialog-portal", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogPrimitive.Content,
      {
        ...
        children: [
          children,
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogPrimitive.Close, { className: "ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", children: [
